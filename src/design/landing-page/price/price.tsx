  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col justify-center items-center space-y-10">
        <div>
          <h2 className="text-4xl sm:text-6xl md:text-7xl lg:text-7xl leading-none font-medium text-center max-w-6xl m-auto">
        ...
        <div className="relative bg-background border border-primary rounded-xl w-full max-w-sm">
          <div className="absolute -rotate-12 w-full max-sm:max-w-[200px] max-w-[400px] h-96 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-500 z-10 blur-[300px] max-sm:blur-[200px]"></div>
