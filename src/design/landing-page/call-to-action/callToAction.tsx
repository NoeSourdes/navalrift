...
export const CallToAction = () => {
  return (
    <div className="relative mt-20">
      <div className="absolute -rotate-12 w-full max-sm:max-w-[200px] max-w-[400px] h-96 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary z-10"></div>
