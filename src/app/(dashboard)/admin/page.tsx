...
export default function Page() {
  ...
  return (
    <div className="h-full w-full flex flex-col gap-6">
      <div className="h-full w-full bg-blue-800/75 rounded-xl flex items-center justify-center gap-6 p-6">
        <div
        ...
        >
          ...
          <div className="max-w-2xl mx-auto p-4">
            <h1 className="relative z-10 text-lg md:text-6xl  bg-clip-text text-transparent bg-foreground  text-center font-sans font-bold">
              Jouer avec <br /> <span className="text-primary">une IA</span>
            </h1>
            <p></p>
        ...
        >
          ...
          <div className="max-w-2xl mx-auto p-4">
            <h1 className="relative z-10 text-lg md:text-6xl  bg-clip-text text-transparent bg-foreground  text-center font-sans font-bold">
              Jouer avec <br /> <span className="text-primary">un ami</span>
            </h1>
            <p></p>
            <p className="text-gray-300 max-w-lg mx-auto my-2 text-sm text-center relative z-10 mt-5">
