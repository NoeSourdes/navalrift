...
export default function Page() {
  ...
  return (
    <div className="h-full w-full flex flex-col gap-6">
      <div className="relative h-full w-full bg-blue-800/75 rounded-xl flex max-md:flex-col items-center justify-center gap-6 p-6">
        <div className="absolute sm:top-12 top-8 left-1/2 text-sm text-gray-300 -translate-x-1/2 h-15 px-3 py-2 rounded-full bg-blue-900 border-2 border-blue-800 z-20 shadow-xl">
          Faites votre choix
        </div>
        <div
          onClick={() => {
          ...
          className="h-full w-full bg-blue-900  dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative flex items-center justify-center rounded-lg overflow-hidden cursor-pointer hover:scale-[1.02] transition-all z-10"
        >
