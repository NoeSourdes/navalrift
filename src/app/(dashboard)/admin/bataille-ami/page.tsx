...
export default function BatailleAmi() {
  ...
  return (
    <div className="relative w-full h-full bg-blue-800/75 rounded-xl p-6">
      ...
      <div className="h-full w-full  bg-blue-900  dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative flex items-center justify-center rounded-lg overflow-hidden cursor-pointer ">
        ...
        <div className="max-w-2xl mx-auto p-4 flex flex-col justify-center items-center gap-3">
          ...
          <Tooltip content="Copier le lien">
            <div
              ...
              className="px-3 py-2 bg-black/35 rounded-xl hover:bg-success/35 transition-all flex items-center gap-2"
            >
              {lien}
              <div
                style={{
